...
public class HashedCPSR extends TPSR {
	...
	public HashedCPSR(TrainingDataSet trainData, double minSingularVal,
			int maxDim, int maxHistLen, int hashedDim, boolean histCompress, int maxTestLen) 
	{
		super(trainData, minSingularVal, maxDim, maxHistLen, maxTestLen);
...
//		resetCount=0;
		...
		pv = PredictionVector.BuildPredctiveVector(svdResults[0].mmul(th.getColumn(0)));
	}
