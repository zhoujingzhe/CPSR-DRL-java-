...
public class CPSR extends TPSR 
{
	...
	public static final int DEF_MAX_Test = 10000;
	...
	public CPSR(TrainingDataSet trainData, double minSingularVal, int maxSVDDim, int projDim, ProjType projType, boolean histCompress, boolean randStart)
	{
		...
		this(trainData, minSingularVal, maxSVDDim, projDim, DEF_MAX_HIST, projType, histCompress, randStart, DEF_MAX_Test);
	}

	public CPSR(TrainingDataSet trainData, double minSingularVal, int maxSVDDim, int projDim, int maxHistLen, ProjType projType, boolean histCompress, boolean randStart, int maxTestLen)
	{
...
//		estimateHistoryAndTHMatrices(1);
		estimateHistoryAndTHMatricesMultiThread(1);
...
//		constructAOMatrices(1);
		constructAOMatricesMuliThread(1);
//		for(ActionObservation actOb : trainData.getValidActionObservationSet())
//		{
...
//		resetCount=0;
		...
		pv = PredictionVector.BuildPredctiveVector(svdResults[0].mmul(th).mmul(e));
	}

	protected void performUpdate()
	{
		System.out.println("The CPSR updates!");
...
//		hist.muli(1.0/((double)resetCount));
		...
		////////////////////////////////////////////////////////////
		//for (DoubleMatrix t_mat: svdResults)
		//{
		//	System.out.print("The svdResults:");
		//	System.out.println(t_mat.toString());
		//}
		////////////////////////////////////////////////////////////
		...
		for(ActionObservation actOb : trainData.getValidActionObservationSet())
		{
			...
			{
				DoubleMatrix aoMat = svdResults[0].mmul(oldU).mmul(aoMats.get(actOb)).mmul(oldS).mmul(oldV.transpose()).mmul(pseudoInverse);
				
				//////////////////////////////////////////////////
				System.out.print("The update term:" + actOb);
				System.out.println(aoMat.toString());
				//////////////////////////////////////////////////
		...
		aoColAddMat = svdResults[0].mmul(tPhi);
		///////////////////////////////////////////
		//System.out.print("The aoColAddMat");
		//System.out.println(aoColAddMat.toString());
		///////////////////////////////////////////
		if(histCompress)
		{
			aoRowAddMat = hPhi.mmul(pseudoInverse);
		...
		///////////////////////////////////////////////////////
		//System.out.print("The aoRowAddMat:");
		//System.out.println(aoRowAddMat.toString());
		///////////////////////////////////////////////////////
...
//		resetCount=0;
		...
		mInf = new Minf(((hist.transpose()).mmul(pseudoInverse)).transpose());
		pv = PredictionVector.BuildPredctiveVector(svdResults[1].mmul(svdResults[2].transpose()).mmul(e));
